...
module "func_sender" {
  ...
  app_settings                              = {
    ...
    PROCESS_RESULTS_PATH                             = data.azurerm_key_vault_secret.kvs_st_data_lake_primary_connection_string.value
    PROCESS_RESULTS_PATH2                            = data.azurerm_key_vault_secret.kvs_st_data_lake_primary_access_key.value
  }
