  ...
  task {
    ...
    python_wheel_task {
      ...
      parameters  = [
          ...
          "--market-participant-events-checkpoint-path=abfss://${local.MARKET_PARTICIPANT_EVENTS_CONTAINER_NAME}@${data.azurerm_key_vault_secret.st_shared_data_lake_name.value}.dfs.core.windows.net/events-checkpoint",
      ]
    }
  }
