locals {
  backend_for_frontend = {
    app_settings = {
      ...
      ProcessManagerHttpClients__GeneralApiBaseAddress        = "@Microsoft.KeyVault(VaultName=${data.azurerm_key_vault.kv_shared_resources.name};SecretName=func-core-pm-base-url)"
