locals {
  backend_for_frontend = {
    app_settings = {
      ...
      ProcessManagerHttpClients__ApplicationIdUri             = "@Microsoft.KeyVault(VaultName=${data.azurerm_key_vault.kv_shared_resources.name};SecretName=processmanager-application-id-uri)"
