module "backend_for_frontend" {
  source = "git::https://github.com/Energinet-DataHub/geh-terraform-modules.git//azure/app-service?ref=app-service_4.0.1"
  ...
  app_settings = {
    ...
    ApiClientSettings__WholesaleOrchestrationSettlementReportsBaseUrl = "@Microsoft.KeyVault(VaultName=${data.azurerm_key_vault.kv_shared_resources.name};SecretName=func-wholesale-settlement-reports-df-base-url)"
