...
resource "azurerm_role_assignment" "ra_dh2landzonearch_contributor" {
...
resource "azurerm_storage_container" "landzonearchive" {
  name                  = "landzonearchive"
  storage_account_name  = module.st_dh2landzone_archive.name
