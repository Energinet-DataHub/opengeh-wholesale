resource "databricks_cluster" "shared_all_purpose" {
  ...
  num_workers             = 1
  spark_conf = {
    "fs.azure.account.oauth2.client.endpoint.${module.st_dh2dropzone.name}.dfs.core.windows.net" : "https://login.microsoftonline.com/${var.tenant_id}/oauth2/token"
    ...
    "fs.azure.account.auth.type.${module.st_dh2dropzone.name}.dfs.core.windows.net" : "OAuth"
    ...
    "fs.azure.account.oauth.provider.type.${module.st_dh2dropzone.name}.dfs.core.windows.net" : "org.apache.hadoop.fs.azurebfs.oauth2.ClientCredsTokenProvider"
    ...
    "fs.azure.account.oauth2.client.id.${module.st_dh2dropzone.name}.dfs.core.windows.net" : databricks_secret.spn_app_id.config_reference
    ...
    "fs.azure.account.oauth2.client.secret.${module.st_dh2dropzone.name}.dfs.core.windows.net" : databricks_secret.spn_app_secret.config_reference
  ...
  spark_env_vars = {
    ...
    "LANDING_STORAGE_ACCOUNT"         = module.st_dh2dropzone.name
