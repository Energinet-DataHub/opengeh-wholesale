...
locals {
  func_orchestrations = {
    app_settings = {
      ...
      "IntegrationEventTopic_Name"  = "@Microsoft.KeyVault(VaultName=${data.azurerm_key_vault.kv_shared_resources.name};SecretName=sbt-shres-integrationevent-received-name)"
