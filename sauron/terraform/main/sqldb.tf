module "mssqldb" {
  ...
  security_groups = var.environment_instance == "001" ? (var.environment_short == "d" || "t" ? concat(local.pim_security_group_rules_001, local.developer_security_group_rules_001_dev_test) : local.pim_security_group_rules_001) : local.developer_security_group_rules_002
