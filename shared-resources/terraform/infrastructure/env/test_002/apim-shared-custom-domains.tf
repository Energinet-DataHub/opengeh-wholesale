resource "azurerm_key_vault_certificate" "b2b_datahub3_certificate" {
  ...
  certificate {
    contents = filebase64("${path.module}/assets/test002_b2b_datahub3_dk.pfx")
...
resource "azurerm_key_vault_certificate" "ebix_datahub3_certificate" {
  ...
  certificate {
    contents = filebase64("${path.module}/assets/test002_ebix_datahub3_dk.pfx")
