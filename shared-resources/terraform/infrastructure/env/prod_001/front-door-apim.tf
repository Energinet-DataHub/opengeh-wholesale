locals {
  environment_short = ["d-002", "t-002", "d-001", "t-001", "b-001", "p-001", "d-003"]      # Only append to the list due to indexes!
  environments      = ["dev002", "test002", "dev", "test", "preprod", "prod001", "dev003"] # Only append to the list due to indexes! prod001 is the only one with a number, as it is checked later on
