...
// Enables authentication delegation - e.g an authorized user can request access token for the API through Visual Studio
resource "azuread_application_pre_authorized" "visualstudio2" {
  application_id       = azuread_application.this.id
...
resource "azuread_app_role_assignment" "developer_sp_role_assignment" {
