...
// Add PIM Contributor group or developer group to electricitymarket service principal
// This enables the groups members to get accesstokens and thus debug the electricitymarket API
resource "azuread_app_role_assignment" "electricitymarket_pim_sp_role_assignment" {
  app_role_id         = "00000000-0000-0000-0000-000000000000" // default role
  resource_object_id  = azuread_service_principal.sp_electricitymarket.object_id
