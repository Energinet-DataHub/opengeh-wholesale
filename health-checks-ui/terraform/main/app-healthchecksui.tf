module "app_health_checks_ui" {
  ...
  app_settings = {
    ...
    "HealthChecksUI__HealthChecks__6__Uri"   = "https://func-migration-mig-${lower(var.environment_short)}-${lower(var.environment_instance)}.azurewebsites.net/api/monitor/ready"
    ...
    "HealthChecksUI__HealthChecks__20__Name" = "Migration: Migration Function - live"
    "HealthChecksUI__HealthChecks__20__Uri"  = "https://func-migration-mig-${lower(var.environment_short)}-${lower(var.environment_instance)}.azurewebsites.net/api/monitor/live"
