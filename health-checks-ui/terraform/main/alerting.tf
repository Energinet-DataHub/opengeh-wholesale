module monitor_action_group_healthcheckui {
  ...
  short_name                      = "hcui-mon-grp"
  email_receiver_name             = "Healthcheck UI Operations"
  email_receiver_address          = var.alert_email_address
  custom_dimension_subsystem_name = "healthchecksui"
