module "app_health_checks_ui" {
  ...
  app_settings = {
    ...
    "HealthChecksUI__HealthChecks__024__Name" = "sauron:::func-githubapi"
    ...
    "HealthChecksUI__HealthChecks__025__Name" = "shared-resources:::func-healthcheck"
    "HealthChecksUI__HealthChecks__025__Uri"  = "https://func-healthchecks-shres-${lower(var.environment_short)}-we-${lower(var.environment_instance)}.azurewebsites.net/api/monitor/ready"
    ...
    "HealthChecksUI__HealthChecks__224__Name" = "sauron:::func-githubapi - live"
    ...
    "HealthChecksUI__HealthChecks__225__Name" = "shared-resources:::func-healthcheck - live"
    "HealthChecksUI__HealthChecks__225__Uri"  = "https://func-healthchecks-shres-${lower(var.environment_short)}-we-${lower(var.environment_instance)}.azurewebsites.net/api/monitor/live"
