module "app_health_checks_ui" {
  ...
  app_settings = {
    ...
    "HealthChecksUI__HealthChecks__016__Uri"  = "https://func-biztalkreceiver-esettdepr-${lower(var.environment_short)}-we-${lower(var.environment_instance)}.azurewebsites.net/monitor/ready"
    "HealthChecksUI__HealthChecks__017__Name" = "Esett Deprecated: ChangeObserver Function"
    "HealthChecksUI__HealthChecks__017__Uri"  = "https://func-changeobserver-esettdepr-${lower(var.environment_short)}-we-${lower(var.environment_instance)}.azurewebsites.net/monitor/ready"
    "HealthChecksUI__HealthChecks__018__Name" = "Esett Deprecated: Converter Function"
    "HealthChecksUI__HealthChecks__018__Uri"  = "https://func-converter-esettdepr-${lower(var.environment_short)}-we-${lower(var.environment_instance)}.azurewebsites.net/monitor/ready"
    "HealthChecksUI__HealthChecks__018__Name" = "Esett Deprecated: EnrichmentIngestor Function"
    "HealthChecksUI__HealthChecks__018__Uri"  = "https://func-enrichmentingestor-esettdepr-${lower(var.environment_short)}-we-${lower(var.environment_instance)}.azurewebsites.net/monitor/ready"
    ...
    "HealthChecksUI__HealthChecks__214__Name" = "Esett Deprecated: Importer Web App"
    ...
    "HealthChecksUI__HealthChecks__215__Name" = "Esett Deprecated: BiztalkShipper Web App"
    ...
    "HealthChecksUI__HealthChecks__216__Name" = "Esett Deprecated: Receiver Function"
    "HealthChecksUI__HealthChecks__216__Uri"  = "https://func-biztalkreceiver-esettdepr-${lower(var.environment_short)}-we-${lower(var.environment_instance)}.azurewebsites.net/monitor/live"
    "HealthChecksUI__HealthChecks__217__Name" = "Esett Deprecated: ChangeObserver Function"
    "HealthChecksUI__HealthChecks__217__Uri"  = "https://func-changeobserver-esettdepr-${lower(var.environment_short)}-we-${lower(var.environment_instance)}.azurewebsites.net/monitor/live"
    "HealthChecksUI__HealthChecks__218__Name" = "Esett Deprecated: Converter Function"
