...
/// </summary>
public sealed class SenderDatabaseFixture : IAsyncLifetime
{
    public SenderDatabaseFixture()
    {
        DatabaseManager = new SenderDatabaseManager();
    }

    public SenderDatabaseManager DatabaseManager { get; }
