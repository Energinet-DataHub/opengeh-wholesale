...
public interface IProcessApplicationServiceV2
{
    ...
    /// </summary>
    Task PublishCalculationResultReadyIntegrationEventsAsync(ProcessCompletedEventDto processCompletedEventDto, CancellationToken token);
}
