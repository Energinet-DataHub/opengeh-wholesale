...
{
    private readonly IHealthCheckEndpointHandler _healthCheckEndpointHandler;

    public HealthCheckEndpoint(IHealthCheckEndpointHandler healthCheckEndpointHandler)
    {
        _healthCheckEndpointHandler = healthCheckEndpointHandler;
    }
    ...
    public Task<HttpResponseData> RunAsync(
        ...
        string endpoint)
    {
        return _healthCheckEndpointHandler.HandleAsync(httpRequest, endpoint);
    }
}
