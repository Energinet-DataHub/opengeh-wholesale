...
public class BatchExecutionStateDomainServiceTests
{
        ...
        Wholesale.Domain.BatchExecutionStateDomainService.BatchExecutionStateDomainService sut)
    {
        ...
        calculatorJobRunnerMock.Setup(runner => runner.GetJobStateAsync(batch.RunId!)).ReturnsAsync(CalculationState.Running);
        ...
        Wholesale.Domain.BatchExecutionStateDomainService.BatchExecutionStateDomainService sut)
    {
        ...
        calculatorJobRunnerMock.Setup(runner => runner.GetJobStateAsync(batch.RunId!)).ReturnsAsync(CalculationState.Completed);
        ...
        Wholesale.Domain.BatchExecutionStateDomainService.BatchExecutionStateDomainService sut)
    {
        ...
        batchRepositoryMock.Setup(repo => repo.GetByStatesAsync(It.IsAny<IEnumerable<BatchExecutionState>>()))
            .ReturnsAsync(executingBatches);
        calculatorJobRunnerMock.Setup(runner => runner.GetJobStateAsync(batch.RunId!)).ReturnsAsync(CalculationState.Canceled);
    ...
    //         (await sut.UpdateExecutionStateAsync()).ToList();
    //
    //     // Assert
