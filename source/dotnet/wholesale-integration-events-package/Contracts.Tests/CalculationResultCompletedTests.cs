...
{
    [Fact]
    public void CalculationResultCompleted_HasCorrectNamespace()
    {
        // Be careful to change the namespace as it is public available
        typeof(CalculationResultCompleted).Namespace.Should().Be("Energinet.DataHub.Wholesale.Contracts.Events");
    }

    [Fact]
    public void CalculationResultCompleted_CodeIsGenerated()
    {
        ...
        CalculationResultCompleted.Parser.Should().NotBeNull();
    }
