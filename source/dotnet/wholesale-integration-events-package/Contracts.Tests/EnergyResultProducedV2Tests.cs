...
public class EnergyResultProducedV2Tests
{
    ...
    {
        // Assert that the code has been generated by an heuristic - if the EnergyResultProducedV2.Parser property exists then the type has most likely been generated
