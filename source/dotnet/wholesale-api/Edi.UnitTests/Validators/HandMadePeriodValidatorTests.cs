...
public class HandMadePeriodValidatorTests
{
    ...
    public void Validate_Period_SuccessValidation()
    {
        ...
        message.Period.Start = Instant.FromUtc(2022, 1, 1, 23, 0, 0).ToString();
        message.Period.End = Instant.FromUtc(2022, 1, 2, 23, 0, 0).ToString();

        // Act
        _sut.Validate(message, out var errors);
    ...
    public void Validate_WrongStartHour_FailsValidation()
    {
        ...
        var message = new AggregatedTimeSeriesRequest();
        message.Period = new Edi.Requests.Period();
        message.Period.Start = Instant.FromUtc(2022, 1, 1, 22, 0, 0).ToString();
        message.Period.End = Instant.FromUtc(2022, 1, 2, 23, 0, 0).ToString();
