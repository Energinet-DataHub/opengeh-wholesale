...
namespace Energinet.DataHub.Wholesale.IntegrationEventPublishing.UnitTests.Infrastructure.Persistence.Batches;
...
public class CompletedBatchRepositoryTests
{
    ...
    public async Task GetLastCompletedOrNullAsync_WhenNone_ReturnsNull(
        Mock<IntegrationEventPublishingDatabaseContext> databaseContextMock)
    {
        // Arrange
        databaseContextMock
    ...
    public async Task GetLastCompletedOrNullAsync_WhenMore_ReturnsLastByCompletedTime(
        ...
        [Frozen] Mock<IntegrationEventPublishingDatabaseContext> databaseContextMock)
    {
        // Arrange
