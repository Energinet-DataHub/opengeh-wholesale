...
public class StartCalculationHandler : IStartCalculationHandler
{
    ...
    public StartCalculationHandler(ICalculationInfrastructureService calculationInfrastructureService, IUnitOfWork unitOfWork, ICalculationRepository calculationRepository)
    {
    ...
    public async Task StartAsync()
    {
        ...
        {
            await _calculationInfrastructureService.StartAsync(calculation.Id).ConfigureAwait(false);
