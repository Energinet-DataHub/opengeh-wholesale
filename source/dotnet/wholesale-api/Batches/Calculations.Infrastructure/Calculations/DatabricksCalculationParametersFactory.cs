...
public class DatabricksCalculationParametersFactory : ICalculationParametersFactory
{
    public RunParameters CreateParameters(Calculation calculation)
    {
        ...
        var jobParameters = new List<string>
        {
            ...
            $"--calculation-grid-areas=[{gridAreas}]",
            $"--calculation-period-start-datetime={calculation.PeriodStart}",
            $"--calculation-period-end-datetime={calculation.PeriodEnd}",
            $"--calculation-process-type={calculation.ProcessType}",
            $"--calculation-execution-time-start={calculation.ExecutionTimeStart}",
        };
