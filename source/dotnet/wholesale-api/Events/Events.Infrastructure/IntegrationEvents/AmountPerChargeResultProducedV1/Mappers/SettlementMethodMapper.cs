...
{
    public static EventSettlementMethod MapSettlementMethod(ModelSettlementMethod? settlementMethod)
    {
        return settlementMethod switch
        {
            ModelSettlementMethod.Flex => EventSettlementMethod.Flex,
            ModelSettlementMethod.NonProfiled => EventSettlementMethod.NonProfiled,
            null => EventSettlementMethod.Unspecified,
