...
using ProcessType = Energinet.DataHub.Wholesale.Contracts.Events.V2.ProcessType;

namespace Energinet.DataHub.Wholesale.Events.Infrastructure.IntegrationEvents.Common.Mappers;
