...
using Xunit;
using EventCalculationType = Energinet.DataHub.Wholesale.Contracts.IntegrationEvents.TotalMonthlyAmountResultProducedV1.Types.CalculationType;
using ModelCalculationType = Energinet.DataHub.Wholesale.Common.Interfaces.Models.CalculationType;

namespace Energinet.DataHub.Wholesale.Events.UnitTests.Infrastructure.IntegrationEvents.TotalMonthlyAmountResultProducedV1.Mappers;
