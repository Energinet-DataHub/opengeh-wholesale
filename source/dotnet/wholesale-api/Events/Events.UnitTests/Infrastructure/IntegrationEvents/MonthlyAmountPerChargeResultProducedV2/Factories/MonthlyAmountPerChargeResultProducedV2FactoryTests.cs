...
using Energinet.DataHub.Wholesale.Events.Infrastructure.IntegrationEvents.MonthlyAmountPerChargeResultProducedV2.Factories;
...
namespace Energinet.DataHub.Wholesale.Events.UnitTests.Infrastructure.IntegrationEvents.MonthlyAmountPerChargeResultProducedV2.Factories;

public class MonthlyAmountPerChargeResultProducedV2FactoryTests
{
        ...
        AmountType amountType, bool expected)
    {
        ...
        var wholesaleResult = new WholesaleResultBuilder()
            ...
            .Build();
        var sut = new MonthlyAmountPerChargeResultProducedV2Factory();
    ...
    public void Create_ReturnsExpectedObject(
        MonthlyAmountPerChargeResultProducedV2Factory sut)
    {
        // Arrange
        var wholesaleResult = new WholesaleResultBuilder()
            .WithResolution(Resolution.Month)
    ...
    [Theory]
    [InlineAutoMoqData]
    public void Create_WhenWholesaleResultHasMoreThanOneTimeSeriesPoints_ThrowsException(MonthlyAmountPerChargeResultProducedV2Factory sut)
    {
        // Arrange
