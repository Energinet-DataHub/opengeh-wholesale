...
public sealed class MeteringPointMasterDataFileGenerator : CsvFileGeneratorBase<SettlementReportMeteringPointMasterDataRow, MeteringPointMasterDataFileGenerator.SettlementReportMeteringPointMasterDataRowMap>
{
    ...
    protected override IAsyncEnumerable<SettlementReportMeteringPointMasterDataRow> GetAsync(SettlementReportRequestFilterDto filter, SettlementReportRequestInputActorInfo actorInfo, long maximumCalculationVersion, int skipChunks, int takeChunks)
    {
