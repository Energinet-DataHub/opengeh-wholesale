...
public sealed class ChargeLinkPeriodsFileGenerator : CsvFileGeneratorBase<SettlementReportChargeLinkPeriodsResultRow, SettlementReportChargeLinkPeriodsResultRowMap>
{
    ...
    protected override IAsyncEnumerable<SettlementReportChargeLinkPeriodsResultRow> GetAsync(SettlementReportRequestFilterDto filter, SettlementReportRequestInputActorInfo actorInfo, long maximumCalculationVersion, int skipChunks, int takeChunks)
    {
