...
public sealed class SettlementReportMonthlyAmountTotalQueries : ISettlementReportMonthlyAmountTotalQueries
{
    ...
    {
        var statement = new SettlementReportMonthlyAmountTotalCountQueryStatement(_deltaTableOptions, filter);
        ...
        throw new InvalidOperationException("Could not count result for SettlementReportMonthlyAmountTotalQueries.");
    }
}
