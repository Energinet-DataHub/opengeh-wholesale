...
public static class SettlementReportMeteringPointMasterDataRowFactory
{
    public static SettlementReportMeteringPointMasterDataRow Create(DatabricksSqlRow databricksSqlRow, long version)
    {
        ...
        var gridArea = databricksSqlRow[SettlementReportMeteringPointMasterDataViewColumns.GridArea];
        var gridAreaFrom = databricksSqlRow[SettlementReportMeteringPointMasterDataViewColumns.GridAreaFrom];
        var gridAreaTo = databricksSqlRow[SettlementReportMeteringPointMasterDataViewColumns.GridAreaTo];
        var settlementMethod = databricksSqlRow[SettlementReportMeteringPointMasterDataViewColumns.SettlementMethod];
        var meteringPointId = databricksSqlRow[SettlementReportMeteringPointMasterDataViewColumns.MeteringPointId];
        var meteringPointType = databricksSqlRow[SettlementReportMeteringPointMasterDataViewColumns.MeteringPointType];
        var energySupplierId = databricksSqlRow[SettlementReportMeteringPointMasterDataViewColumns.EnergySupplierId];

        return new SettlementReportMeteringPointMasterDataRow(
            meteringPointId!,
