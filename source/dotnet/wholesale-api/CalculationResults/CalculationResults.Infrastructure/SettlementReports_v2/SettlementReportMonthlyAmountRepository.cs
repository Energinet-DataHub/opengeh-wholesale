...
public sealed class SettlementReportMonthlyAmountRepository : ISettlementReportMonthlyAmountRepository
{
    ...
    public async IAsyncEnumerable<SettlementReportMonthlyAmountRow> GetAsync(SettlementReportRequestFilterDto filter, int skip, int take)
    {
    ...
    private static SettlementReportMonthlyAmountQueryFilter ParseFilter(SettlementReportRequestFilterDto filter)
    {
