...
public class DatabricksSchemaManager
{
    ...
    public async Task CreateSchemaAsync()
    {
        ...
        await CreateTableAsync(DeltaTableOptions.Value.ENERGY_RESULTS_POINTS_GA_V1_VIEW_NAME, SettlementReportEnergyResultViewSchemaDefinition.SchemaDefinition);
