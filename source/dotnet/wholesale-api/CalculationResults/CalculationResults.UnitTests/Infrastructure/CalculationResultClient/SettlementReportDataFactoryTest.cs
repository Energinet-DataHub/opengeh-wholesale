...
public class SettlementReportDataFactoryTests
{
    ...
    public SettlementReportDataFactoryTests()
    {
        ...
        {
            new[] { "123", "Aggregation", "2022-05-16T01:00:00.000Z", "non_profiled_consumption", "1.1" },
        ...
        _firstRow = new SettlementReportResultRow("123", ProcessType.Aggregation, Instant.FromUtc(2022, 5, 16, 1, 0, 0), "PT15M", MeteringPointType.Consumption, SettlementMethod.NonProfiled, new decimal(1.1));
