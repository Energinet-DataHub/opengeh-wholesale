...
public class WholesaleResultQueriesTests
{
    ...
    //     var row0 = new[] { _row0CalculationId, "100", "200", "non_profiled_consumption", string.Empty, string.Empty, "2022-05-16T22:00:00.000Z", "1.111", "measured", _calculationResultId0, DeltaTableProcessType.Aggregation };
    ...
    //     actualPoint.Qualities.Should().Be(QuantityQuality.Measured);
    // }
    //
    // [Theory]
    // [InlineAutoMoqData]
