...
namespace Energinet.DataHub.Wholesale.DomainTests.Features.Databricks.Fixtures
{
    /// <summary>
    ...
    /// </summary>
    public class CalculationJobScenarioConfiguration : DomainTestConfiguration
    {
