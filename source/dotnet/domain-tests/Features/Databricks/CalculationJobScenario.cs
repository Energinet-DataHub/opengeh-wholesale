...
namespace Energinet.DataHub.Wholesale.DomainTests.Features.Databricks
{
    [TestCaseOrderer(
    ...
    public class CalculationJobScenario : DomainTestsBase<CalculationJobScenarioFixture>
    {
