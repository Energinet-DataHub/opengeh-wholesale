        ...
        public class BalanceFixingCalculationScenario : DomainTestsBase<CalculationScenarioFixture>
        {
            ...
            public async Task Then_CalculationIsCompletedWithinWaitTime()
            {
                var actualWaitResult = await Fixture.WaitForCalculationStateAsync(
                    ...
                    waitTimeLimit: TimeSpan.FromMinutes(16));
            ...
            public async Task AndThen_IntegrationEventsAreReceivedWithinWaitTime()
            {
                ...
                Fixture.ScenarioState.ReceivedAmountPerChargeResultProducedV1 = actualReceivedIntegrationEvents.OfType<AmountPerChargeResultProducedV1>().ToList();
                Fixture.ScenarioState.ReceivedMonthlyAmountPerChargeResultProducedV1 = actualReceivedIntegrationEvents.OfType<MonthlyAmountPerChargeResultProducedV1>().ToList();
