...
internal static class JwtTokenSecurityRegistration
{
    /// <summary>
    ...
    public static void AddJwtTokenSecurity(this IServiceCollection serviceCollection, IConfiguration configuration)
    {
        ...
        var address = configuration.GetSetting(Settings.FrontEndOpenIdUrl);
        var audience = configuration.GetSetting(Settings.FrontEndServiceAppId);
