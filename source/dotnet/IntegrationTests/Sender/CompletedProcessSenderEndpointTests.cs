...
public class CompletedProcessSenderEndpointTests
{
    ...
    public class RunAsync : FunctionAppTestBase<SenderFunctionAppFixture>, IAsyncLifetime
    {
        ...
        public async Task CompletedProcessTestAsync()
        {
            ...
            var completedProcess = new CompletedProcess("123");
            ...
            var message = ServiceBusTestMessage.Create(byteArray, operationTimestamp);
            // Act
            await Fixture.CompletedProcessTopic.SenderClient.SendMessageAsync(message);

            // Assert
            await FunctionAsserts.AssertHasExecutedAsync(Fixture.HostManager, nameof(CompletedProcessSenderEndpoint))
                .ConfigureAwait(false);
        ...
        public byte[] ConvertObjectToByteArray(CompletedProcess completedProcess)
        {
