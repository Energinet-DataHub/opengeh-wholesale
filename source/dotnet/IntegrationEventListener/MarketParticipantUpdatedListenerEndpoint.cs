...
{
    public class MarketParticipantUpdatedListenerEndpoint
    {
        private const string FunctionName = nameof(MarketParticipantUpdatedListenerEndpoint);
        ...
        public MarketParticipantUpdatedListenerEndpoint(
            ...
            byte[] message)
        {
            ...
            switch (marketParticipantEvent)
            {
                ...
                default:
                    // Currently, only one of the events is relevant.
                    return null;
            }
        }
    }
