...
public class JobSettings : RunSettings<JobSettings>
{
        ...
        IEnumerable<string> parameters, IEnumerable<string> jarLibs)
    {
        ...
        {
            Name = jobName,
            SparkJarTask = new SparkJarTask { MainClassName = mainClass, Parameters = parameters?.ToList() },
        ...
        Dictionary<string, string> parameters)
    {
        ...
        {
            Name = jobName,
            NotebookTask = new NotebookTask { NotebookPath = notebookPath, BaseParameters = parameters },
            SparkJarTask = null,
            SparkPythonTask = null,
            SparkSubmitTask = null,
            Libraries = null
