...
{
    [JsonProperty(PropertyName = "pypi")] public PythonPyPiLibrarySpec PythonPyPiLibrarySpec { get; set; }
...
{
    [JsonProperty(PropertyName = "cran")] public RCranLibrarySpec RCranLibrarySpec { get; set; }
...
{
    [JsonProperty(PropertyName = "maven")] public MavenLibrarySpec MavenLibrarySpec { get; set; }
