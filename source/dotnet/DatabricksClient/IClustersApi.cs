...
public interface IClustersApi : IDisposable
{
    ...
    Task<EventsResponse> Events(string clusterId, DateTimeOffset? startTime = null, DateTimeOffset? endTime = null,
        ListOrder? order = null, IEnumerable<ClusterEventType> eventTypes = null, long? offset = null,
        long? limit = null, CancellationToken cancellationToken = default);
}
