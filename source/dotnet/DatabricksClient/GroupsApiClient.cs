...
public class GroupsApiClient : ApiClient, IGroupsApi
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            UserName = principalName.UserName, GroupName = principalName.GroupName, ParentName = parentGroupName
        };
    ...
    {
        var response = await HttpPost<dynamic, dynamic>(this.HttpClient, "groups/create",
                new { group_name = groupName }, cancellationToken)
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await HttpPost(this.HttpClient, "groups/remove-member", groupMembership, cancellationToken)
            .ConfigureAwait(false);
    }
