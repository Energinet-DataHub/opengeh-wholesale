...
public class DiskType
{
    ...
    public static DiskType FromAzureDisk(AzureDiskVolumeType volumeType)
    {
        return new() { AzureDiskVolumeType = volumeType };
    }

    public static DiskType FromEbsDisk(EbsVolumeType volumeType)
    {
        return new() { EbsVolumeType = volumeType };
    }
}
