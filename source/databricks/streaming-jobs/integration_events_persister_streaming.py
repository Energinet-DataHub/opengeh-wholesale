...
streamingDF = (spark.readStream.format("eventhubs").options(**input_configuration).load().withColumn(col("body")).cast('string').withColumn("body", from_json(col("body")), schema))
