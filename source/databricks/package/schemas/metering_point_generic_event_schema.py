...
# Schema is used for both created and connected despite
# the events to each having all the columns.
# TODO: Must be addressed when adding tests for getting metering points in upcoming PR.
