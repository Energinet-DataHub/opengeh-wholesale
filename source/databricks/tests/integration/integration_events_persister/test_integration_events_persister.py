...
def integration_events_persister_tester(
    ...
    event_hub_streaming_simulation_path = f"{delta_lake_path}/event_hub_streaming_simulation"
...
async def test_process_json(parquet_reader, integration_events_persister_tester):
    ...
    succeeded = streaming_job_asserter(integration_events_persister_tester, verification_function)
