        ...
        df = [
            {
                ...
                Colname.observation_time: timestamp_factory("2022-06-10T12:15:00.000Z"),
                Colname.observation_time_year: 2022,
                Colname.observation_time_month: 6,
                Colname.observation_time_day: 8,
            },
            {
                "MeteringPointId": "the-meteringpoint-id",
                "TransactionId": "1",
