...
def test_connection_state_is_subset_of_contract(source_path: str) -> None:
...
def test_metering_point_type_is_subset_of_contract(source_path: str) -> None:
    assert_codelist_matches_contract(
        MeteringPointType,
...
def test_settlement_method_is_subset_of_contract(source_path: str) -> None:
    assert_codelist_matches_contract(
        SettlementMethod,
...
def test_quality_is_subset_of_contract(source_path: str) -> None:
    assert_codelist_matches_contract(
...
def test_resolution_is_subset_of_contract(source_path: str) -> None:
    assert_codelist_matches_contract(
        TimeSeriesResolution,
