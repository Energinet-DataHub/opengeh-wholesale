...
@pytest.mark.parametrize(
    ...
    [
        (datetime(2024, 1, 2, 23), datetime(2024, 1, 10, 23), 1),
        (datetime(2024, 1, 5, 23), datetime(2024, 1, 10, 23), 0),
    ],
)
def test_time(
    spark: SparkSession, args_start_date, args_end_date, expected_rows
) -> None:
    # Arrange
