...
def test_execute_monthly_amount__when_standard_wholesale_fixing_scenario__returns_expected_number_of_files_and_content(
    spark: SparkSession,
    ...
    try:
        ...
        # Assert
        actual_files = dbutils.jobs.taskValues.get("monthly_amount_files")
