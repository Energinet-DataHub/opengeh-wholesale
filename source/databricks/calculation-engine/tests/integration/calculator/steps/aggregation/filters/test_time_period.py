...
from_time_utc = datetime.strptime(
    "2019-01-01T00:00:00+0000", date_time_formatting_string
)
to_time_pst = datetime.strptime("2020-01-01T00:00:00-0800", date_time_formatting_string)
from_time_pst = datetime.strptime(
    "2019-01-01T00:00:00-0800", date_time_formatting_string
)
    ...
    pandas_df = pd.DataFrame(
        {
            Colname.observation_time: [
                ...
                datetime.strptime(
                    "2019-02-01T00:00:00+0000", date_time_formatting_string
                ),
                datetime.strptime(
                    "2020-01-01T00:00:00+0000", date_time_formatting_string
                ),
                datetime.strptime(
                    "2021-01-01T00:00:00+0000", date_time_formatting_string
                ),
            ],
            "id": [1, 2, 3, 4, 5],
        }
...
def test_time_period_utc_filter_filters_out_rows_not_in_range(
    time_period_utc_filtered_data_frame,
):
...
def test_time_period_pst_filter_filters_out_rows_not_in_range(
    time_period_pst_filtered_data_frame,
):
