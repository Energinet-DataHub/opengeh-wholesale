...
def test_grid_loss_calculation_calculates_correctly_on_grid_area(
    ...
    non_profiled_consumption_ga = create_dataframe_from_aggregation_result_schema(
        agg_hourly_consumption_factory()
    )
    flex_consumption_ga = create_dataframe_from_aggregation_result_schema(agg_flex_consumption_factory())
    production_ga = create_dataframe_from_aggregation_result_schema(agg_hourly_production_factory())

    result = calculate_residual_ga(net_exchange_per_ga, non_profiled_consumption_ga, flex_consumption_ga, production_ga)
