...
def apply(args: MigrationScriptArgs) -> None:
    """
    In 202302211500_Restructure_Actors_Directory.py a backup/temp folder was created with the original actors data.
    Since that migration succeeded we can now remove the temp folder from the datalake
    """
