...
from package.codelists import InputMeteringPointType, MeteringPointType


DEFAULT_FROM_TIME = datetime.strptime("2000-01-01T23:00:00+0000", "%Y-%m-%dT%H:%M:%S%z")

GRID_AREA_RESPONSIBLE = [
    ('571313180480500149', 804, DEFAULT_FROM_TIME, None, InputMeteringPointType.PRODUCTION.value, '8100000000108'),
    ('570715000000682292', 512, DEFAULT_FROM_TIME, None, InputMeteringPointType.PRODUCTION.value, '5790002437717'),
    ('571313154313676325', 543, DEFAULT_FROM_TIME, None, InputMeteringPointType.PRODUCTION.value, '5790002437717'),
    ('571313153313676335', 533, DEFAULT_FROM_TIME, None, InputMeteringPointType.PRODUCTION.value, '5790002437717'),
    ('571313154391364862', 584, DEFAULT_FROM_TIME, None, InputMeteringPointType.PRODUCTION.value, '5790002437717'),
    ('579900000000000026', 990, DEFAULT_FROM_TIME, None, InputMeteringPointType.PRODUCTION.value, '4260024590017'),
    ('571313180300014979', 803, DEFAULT_FROM_TIME, None, InputMeteringPointType.PRODUCTION.value, '8100000000108'),
    ('571313180400100657', 804, DEFAULT_FROM_TIME, None, InputMeteringPointType.CONSUMPTION.value, '8100000000115'),
    ('578030000000000012', 803, DEFAULT_FROM_TIME, None, InputMeteringPointType.CONSUMPTION.value, '8100000000108'),
    ('571313154312753911', 543, DEFAULT_FROM_TIME, None, InputMeteringPointType.CONSUMPTION.value, '5790001103095'),
    ('571313153308031507', 533, DEFAULT_FROM_TIME, None, InputMeteringPointType.CONSUMPTION.value, '5790001102357'),
    ('571313158410300060', 584, DEFAULT_FROM_TIME, None, InputMeteringPointType.CONSUMPTION.value, '5790001103095')
]
