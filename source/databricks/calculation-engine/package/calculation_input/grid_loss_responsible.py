...
GRID_AREA_RESPONSIBLE = [
    ...
    ('571313153313676335', 533, DEFAULT_FROM_TIME, None, MeteringPointType.PRODUCTION.value, '5790002437717'), # noqa
    ('571313154391364862', 584, DEFAULT_FROM_TIME, None, MeteringPointType.PRODUCTION.value, '5790002437717'), # noqa
    ('579900000000000026', 990, DEFAULT_FROM_TIME, None, MeteringPointType.PRODUCTION.value, '4260024590017'), # noqa
    ('571313180300014979', 803, DEFAULT_FROM_TIME, None, MeteringPointType.PRODUCTION.value, '8100000000108'), # noqa
    ('571313180400100657', 804, DEFAULT_FROM_TIME, None, MeteringPointType.CONSUMPTION.value, '8100000000115'), # noqa
    ('578030000000000012', 803, DEFAULT_FROM_TIME, None, MeteringPointType.CONSUMPTION.value, '8100000000108'), # noqa
    ('571313154312753911', 543, DEFAULT_FROM_TIME, None, MeteringPointType.CONSUMPTION.value, '5790001103095'), # noqa
    ('571313153308031507', 533, DEFAULT_FROM_TIME, None, MeteringPointType.CONSUMPTION.value, '5790001102357'), # noqa
    ('571313158410300060', 584, DEFAULT_FROM_TIME, None, MeteringPointType.CONSUMPTION.value, '5790001103095')  # noqa
]
# fmt: on
