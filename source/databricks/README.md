...
### Building and bublishing a Docker image for testing

In the CI pipeline, the tests are executed towards a Docker image, which is descripted in the a [Dockerfile](../../.devcontainer/Dockerfile).
