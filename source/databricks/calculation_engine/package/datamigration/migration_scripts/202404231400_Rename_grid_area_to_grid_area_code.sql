...
ALTER TABLE {HIVE_OUTPUT_DATABASE_NAME}.energy_results SET TBLPROPERTIES (
...
ALTER TABLE {HIVE_OUTPUT_DATABASE_NAME}.wholesale_results SET TBLPROPERTIES (
    'delta.columnMapping.mode' = 'name',
    'delta.minReaderVersion' = '2',
    'delta.minWriterVersion' = '5')
GO
...
ALTER TABLE {HIVE_OUTPUT_DATABASE_NAME}.total_monthly_amounts SET TBLPROPERTIES (
    'delta.columnMapping.mode' = 'name',
    'delta.minReaderVersion' = '2',
    'delta.minWriterVersion' = '5')
GO
