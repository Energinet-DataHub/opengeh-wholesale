CREATE VIEW IF NOT EXISTS {CATALOG_NAME}.{WHOLESALE_INTERNAL_DATABASE_NAME}.{WHOLESALE_SETTLEMENT_REPORTS_DATABASE_NAME}.charge_prices_v1 as
SELECT
  c.calculation_id,
...
INNER JOIN {CATALOG_NAME}.{WHOLESALE_INTERNAL_DATABASE_NAME}.calculations AS c ON cm.calculation_id = c.calculation_id
