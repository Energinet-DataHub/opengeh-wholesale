CREATE TABLE IF NOT EXISTS {CATALOG_NAME}.{WHOLESALE_RESULTS_INTERNAL_DATABASE_NAME}.energy_results
(
...
TBLPROPERTIES (
    ...
    delta.constraints.result_id_chk = "LENGTH ( calculation_result_id ) = 36",
