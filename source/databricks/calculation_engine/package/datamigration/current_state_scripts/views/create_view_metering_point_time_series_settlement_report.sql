CREATE VIEW view_metering_point_time_series_settlement_report as
...
FROM basis_data.metering_point_periods AS m
         JOIN (SELECT * FROM basis_data.time_series_points order by observation_time) AS t ON m.metering_point_id = t.metering_point_id AND m.calculation_id = t.calculation_id
