...
def get_schema_config(catalog_name: str) -> list[Schema]:
    return [
        Schema(
        ...
        Schema(
            ...
            views=[
                View(
                    name=paths.HiveOutputDatabase.SUCCEEDED_ENERGY_RESULTS_V1_VIEW_NAME
                ),
            ],
        ),
        Schema(
        ...
        Schema(
            ...
            views=[
                ...
                View(
                    name=paths.SettlementReportPublicDataModel.CHARGE_PRICES_VIEW_NAME_V1
                ),
                View(
