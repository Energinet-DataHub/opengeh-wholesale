...
class CalculatorArgs(ApplicationSettings):
    ...
    calculation_grid_areas: list[str] = Field(..., validation_alias=AliasChoices('grid_areas', 'grid-areas', 'calculation_grid_areas')) #From CLI
    calculation_period_start_datetime: datetime = Field(..., validation_alias=AliasChoices('period_start_datetime', 'period-start-datetime', 'calculation_period_start_datetime')) #From CLI
    calculation_period_end_datetime: datetime = Field(..., validation_alias=AliasChoices('period_end_datetime', 'period-end-datetime', 'calculation_period_end_datetime')) #From CLI
    calculation_type: CalculationType #From CLI
    calculation_execution_time_start: datetime = Field(default=datetime.now(timezone.utc))
