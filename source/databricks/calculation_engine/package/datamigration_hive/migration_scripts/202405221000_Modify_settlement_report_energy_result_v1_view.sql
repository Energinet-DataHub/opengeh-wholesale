...
CREATE VIEW IF NOT EXISTS {HIVE_SETTLEMENT_REPORT_DATABASE_NAME}.energy_results_v1 as
...
INNER JOIN (SELECT calculation_id FROM {HIVE_BASIS_DATA_DATABASE_NAME}.calculations) AS c ON c.calculation_id = e.calculation_id
