...
FROM (
    ...
    INNER JOIN {BASIS_DATA_DATABASE_NAME}.metering_point_periods AS m ON m.metering_point_id = l.metering_point_id
...
WHERE subquery.from_date < subquery.to_date AND subquery.to_date > subquery.from_date;
