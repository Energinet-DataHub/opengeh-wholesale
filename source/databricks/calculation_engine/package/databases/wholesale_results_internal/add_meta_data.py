...
def _add_calculation_result_id(
    ...
    """
    The Databricks engine is not fund of non-deterministic functions like 'uuid()' therefore the result id
    is generated by concatenating values of selected partition columns and convert them into a deterministic uuid.
    """
