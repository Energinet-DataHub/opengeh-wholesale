...
def add_metadata(
    ...
    df = _add_calculation_result_id(
        df, column_group_for_calculation_result_id, table_name
    )
...
def _add_calculation_result_id(
    ...
    Therefore, the result id is now generated by concatenating values of selected
    partition columns and the table name, and converting the concatenated value into a deterministic uuid using uuid5.
    """
    ...
    # Add column "table_name" to make sure the generated uuid is unique across tables
