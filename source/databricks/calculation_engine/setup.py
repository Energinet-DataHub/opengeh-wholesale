...
setup(
    ...
    install_requires=[
        ...
        "azure-core==1.32.0",
        "pytest-xdist",
        "geh_common @ git+https://git@github.com/Energinet-DataHub/opengeh-python-packages@bjarke/improve-scenario-tests-assertions-performance#subdirectory=source/geh_common",
    ],
    entry_points={
        "console_scripts": [
