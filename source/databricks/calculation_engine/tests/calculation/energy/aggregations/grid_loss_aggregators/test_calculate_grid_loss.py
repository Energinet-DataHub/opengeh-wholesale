...
class TestWhenValidInput:
    @pytest.mark.parametrize(
        "exchange_per_ga_qualities, non_profiled_consumption_qualities, flex_consumption_qualities, production_qualities",
        [
    ...
    def test_returns_quality_calculated(
        self,
        spark: SparkSession,
        exchange_per_ga_qualities: list[QuantityQuality],
        ...
        # Arrange
        exchange = self._create_energy_results(spark, exchange_per_ga_qualities)
...
class TestWhenEnergyResultsIsEmpty:
    @pytest.mark.parametrize(
        "exchange_per_ga, non_profiled_consumption, flex_consumption, production, expected_quantity",
        [
            (  # Empty non profiled
    ...
    def test_returns_correct_quantity(
        ...
        # Arrange
        exchange = factories.create(spark, exchange_per_ga)
