...
def test_special_quantity_rounding_when_two_energy_supplier_at_the_same_time(
    ...
    assert actual.collect()[3][Colname.quantity] == Decimal("222.031")
    # Energy supplier 2
    assert actual.collect()[4][Colname.quantity] == Decimal("222.031")
    assert actual.collect()[5][Colname.quantity] == Decimal("222.031")
    assert actual.collect()[6][Colname.quantity] == Decimal("222.030")
    assert actual.collect()[7][Colname.quantity] == Decimal("222.031")
