...
from package.infrastructure.paths import (
    ...
    ENERGY_RESULTS_PER_GA_SETTLEMENT_REPORT_VIEW_NAME_V1,
...
class SettlementReportViewReader:
    ...
    @staticmethod
    def read_energy_results_per_ga_v1(spark: SparkSession) -> DataFrame:
        return spark.read.format("delta").table(
            f"{SETTLEMENT_REPORT_DATABASE_NAME}.{ENERGY_RESULTS_PER_GA_SETTLEMENT_REPORT_VIEW_NAME_V1}"
        )
