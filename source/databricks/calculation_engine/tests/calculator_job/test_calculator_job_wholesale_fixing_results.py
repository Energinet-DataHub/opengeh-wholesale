...
from package.codelists import (
    ...
    MeteringPointType,
    SettlementMethod,
    TimeSeriesType, ChargeResolution,
)
...
WHOLESALE_RESULT_TYPES = [
    (ChargeType.TARIFF, MeteringPointType.CONSUMPTION, SettlementMethod.FLEX, ChargeResolution.HOUR),
    (ChargeType.TARIFF, MeteringPointType.CONSUMPTION, SettlementMethod.NON_PROFILED, ChargeResolution.HOUR),
    (ChargeType.TARIFF, MeteringPointType.PRODUCTION, None, ChargeResolution.HOUR),
    (ChargeType.TARIFF, MeteringPointType.CONSUMPTION, SettlementMethod.FLEX, ChargeResolution.DAY),
    (ChargeType.TARIFF, MeteringPointType.CONSUMPTION, SettlementMethod.NON_PROFILED, ChargeResolution.DAY),
