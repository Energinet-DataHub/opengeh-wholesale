-- CREATE TABLE IF NOT EXISTS {CATALOG_NAME}.{WHOLESALE_RESULTS_INTERNAL_DATABASE_NAME}.exchange_per_neighbor_ga
-- (
--     calculation_id STRING NOT NULL,
--     result_id STRING NOT NULL,
--     grid_area_code STRING NOT NULL,
--     neighbor_grid_area_code STRING NOT NULL,
...
--     delta.constraints.neighbor_grid_area_code_chk = "LENGTH ( neighbor_grid_area_code ) = 3",
