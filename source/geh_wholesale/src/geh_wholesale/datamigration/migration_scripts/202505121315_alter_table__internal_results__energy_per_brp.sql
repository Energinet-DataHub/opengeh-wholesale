...
--     delta.constraints.balance_responsible_party_id_chk = "LENGTH ( balance_responsible_party_id ) = 13 OR LENGTH ( balance_responsible_party_id ) = 16",
--     delta.constraints.time_series_type_chk = "time_series_type IN ( 'production' , 'non_profiled_consumption' , 'flex_consumption' )",
...
CLUSTER BY (calculation_id, result_id, grid_area_code, time)