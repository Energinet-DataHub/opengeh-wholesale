...
class UnityCatalogDatabaseNames(BaseSettings):
    ...
    WHOLESALE_MIGRATION: str = Field(init=False)
...
class MigrationsWholesaleDatabase:
    WHOLESALE_MIGRATION = UnityCatalogDatabaseNames().WHOLESALE_MIGRATION
    ...
    CHARGE_PRICE_INFORMATION_PERIODS_TABLE_NAME = "charge_price_information_periods_view_v1"
...
class WholesaleResultsInternalDatabase:
    ...
    GRID_LOSS_METERING_POINT_TIME_SERIES_TABLE_NAME = "grid_loss_metering_point_time_series"
...
class WholesaleResultsDatabase:
    ...
    GRID_LOSS_METERING_POINT_TIME_SERIES_VIEW_NAME = "grid_loss_metering_point_time_series_v1"
