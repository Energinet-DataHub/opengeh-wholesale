module "func_biztalkreceiver" {
  ...
  app_settings = {
    ...
    BLOB_FILES_CONFIRMED_CONTAINER_NAME                                   = local.blob_files_confirmed_container_name
    BLOB_FILES_SENT_CONTAINER_NAME                                        = local.blob_files_sent_container_name
    BLOB_FILES_OTHER_CONTAINER_NAME                                       = local.blob_files_other_container_name
    BLOB_FILES_ACK_CONTAINER_NAME                                         = local.blob_files_ack_container_name
    BLOB_FILES_MGA_IMBALANCE_CONTAINER_NAME                               = local.blob_files_mga_imbalance_container_name
    BLOB_FILES_BRP_CHANGE_CONTAINER_NAME                                  = local.blob_files_brp_change_container_name
